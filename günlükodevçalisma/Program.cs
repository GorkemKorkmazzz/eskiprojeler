...
namespace gunlukOdev
{
    ...
    class Program
    {
        ...
        {
            Console.Clear();
            using StreamWriter writer = new StreamWriter("yenikullanici.txt", true);
            ...
            Kullanıcılar yenikayit1 = new Kullanıcılar
            {
        ...
        static void KullanıcıBilgileriGoster()
        {
            ...
            if (secim1 == "1")
            {
                ...
                string[] lines = File.ReadAllLines("yenikullanici.txt");
